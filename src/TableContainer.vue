  ...
  <div class="table-container">
    <div class="table">
      ...
      >
        <el-table-column
          ...
          :formatter="
            (row, column, cellValue) =>
              formatterTableColumnValue(row, column, cellValue, col)
          "
        ...
        <el-table-column
          label="操作"
          v-if="tableOps.length"
          width="50"
          align="center"
        >
          <template slot-scope="scope">
            <el-dropdown
              @command="(command) => handleOpTableItem(command, scope)"
              size="mini"
            >
...
export default {
  ...
  data() {
    return {
      ...
      stripe:
        this.elTableStripe === undefined
          ? TableMixinConfig.EL_TABLE_STRIPE
          : this.elTableStripe,
      border:
        this.elTableBorder === undefined
          ? TableMixinConfig.EL_TABLE_BORDER
          : this.elTableBorder,
